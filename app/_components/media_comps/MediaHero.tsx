  ...
  return (
    <figure
      className={`
        flex gap-6
        bg-linear-to-r from-iplay-white/5 to-iplay-grape/5
        rounded-md px-5 py-10 overflow-hidden items-start
        ${className}
      `}
    >
      <div
      ...
      >
        ...
        <div className="absolute inset-0 -z-10">
          <MediaHeroImage
            image={background}
            className="object-cover blur-[8vh] scale-110 w-full h-full"
          />
        </div>
        ...
        <div className="relative z-10 w-full h-full">
          <MediaHeroImage
            image={foreground}
            className="object-cover rounded-lg border border-iplay-white/5 w-full h-full"
          />
        </div>
      </div>
